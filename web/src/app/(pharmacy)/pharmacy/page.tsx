...
function PharmacyKpiHeader() {
  ...
  const h1Units = inventory
    .filter((item) => item.category === "CONTROLLED_H1")
    .reduce((acc, curr) => acc + curr.stockQuantity, 0);
      ...
      <HmsCard elevated className="border-l-4 border-l-teal-500">
        <div className="flex justify-between items-center">
          <div>
            ...
            <h3 className="text-2xl font-bold text-teal-800 mt-1">{inventory.length} Items</h3>
        ...
        <HmsCard elevated className="border-l-4 border-l-rose-500 hover:shadow-md cursor-pointer transition-shadow">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h3 className="text-2xl font-bold text-rose-600 mt-1">{lowStockCount} SKUs Low</h3>
      ...
      <HmsCard elevated className="border-l-4 border-l-purple-500">
        <div className="flex justify-between items-center">
          <div>
            ...
            <h3 className="text-2xl font-bold text-purple-800 mt-1">{h1Units} Narcotic Units</h3>
