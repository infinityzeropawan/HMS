...
const INITIAL_PLANS: PlanConfig[] = [
  {
    ...
    sla: "Standard (9x5)",
    status: "ACTIVE",
    includedFeatures: ["FEAT-CLIN-01", "FEAT-BIZ-01"],
    restrictedFeatures: ["FEAT-CLIN-02", "FEAT-CLIN-03", "FEAT-CLIN-04", "FEAT-CLIN-06", "FEAT-CLIN-07", "FEAT-CLIN-08", "FEAT-BIZ-02", "FEAT-INT-01", "FEAT-INT-02", "FEAT-PREM-01", "FEAT-PREM-02"],
  ...
  },
  {
    ...
    sla: "Priority 24/7",
    status: "ACTIVE",
    includedFeatures: ["FEAT-CLIN-01", "FEAT-CLIN-02", "FEAT-CLIN-03", "FEAT-CLIN-04", "FEAT-CLIN-05", "FEAT-BIZ-01", "FEAT-BIZ-02", "FEAT-BIZ-03", "FEAT-INT-01"],
    restrictedFeatures: ["FEAT-CLIN-06", "FEAT-CLIN-08", "FEAT-INT-02", "FEAT-PREM-01", "FEAT-PREM-02"],
