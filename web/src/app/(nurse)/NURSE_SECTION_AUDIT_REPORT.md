...
| ID | Finding | Evidence |
|---|---|---|
| **M1** | Orders worklist: 6-column `Table`, **no `overflow-x-auto` and no mobile card view** → overflow on phones | `NurseDoctorOrdersWorklist.tsx:356` |
| **M2** | Medication Command Center table: no wrapper/mobile view | `NurseMedicationCommandCenter.tsx:163` |
...
1. **Patient safety**: N2, N9, N10, N11, N12, N13, N16, N20, N24
2. **Flow connectivity**: shared nurse task + MAR stores derived from `hms_clinical_encounters_store` and the pharmacy queue (N14, N15, N21, N22, N23)
3. **Routing/duplicates**: N1, N4, N5, D1–D6
4. **Mobile**: M1–M7, M9
5. **Cleanup**: N6, N17, N18, N19, N25–N28
