...
export default function ShiftHandoverPage() {
  ...
  return (
    <HmsAppShell title="Shift Handover" subtitle="Structured continuity record for safe nursing handoffs">
      <div className="bg-gradient-to-b from-slate-50 to-white safe-area-padding safe-area-bottom">
