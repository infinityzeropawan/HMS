...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col justify-between p-4 sm:p-6 overflow-y-auto safe-area-padding">
      {/* Background Subtle Gradient */}
      <div className="fixed inset-0 bg-gradient-to-b from-primary-light-teal/30 via-white to-slate-50 pointer-events-none" />

      <div className="flex-1 flex items-center justify-center w-full z-10 my-auto py-6">
